...
var Image = function Image(_ref) {
  ...
  return showImage ? !isItemLoaded || !isItemLoaded.error ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("img", {
    className: "rt-lightbox__image".concat(isItemLoaded && !isItemLoaded.error ? ' rt-lightbox__image--visible' : ''),
    src: src,
    onLoad: onLoad,
    ...
    onError: onError
  }) : isItemLoaded.error ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
    onMouseDown: onMouseDown,
    onTouchstart: onTouchStart,
    onMouseUp: onMouseUp,
    onMouseMove: onMouseMove,
  ...
  }, "[url: \"", src, "\"]", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), errorText || '...') : null : null;
};
...
var RTJS_lightbox = function RTJS_lightbox(selector, options) {
  var finalOptions = _objectSpread(_objectSpread({}, _options__WEBPACK_IMPORTED_MODULE_1__["defaultOptions"]), options); // lightbox react app
  ...
  var App = function App(_ref) {
    ...
    var swipeOriginX = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null); // lifecycle
    ...
    }, [selectedItem, loadedImages, forcedLoading]); // useEffect(() => {
    //     if(visible){
    ...
    var isLoaded = img && loadedImages ? loadedImages['item-' + selectedItem] : undefined;
    var isMultiple = galleryItems ? galleryItems.length > 1 : undefined; // console.log(loadedImages)
    ...
    return visible ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
      ...
      onLoad: function onLoad() {
        if (!isLoaded) {
          setTimeout(function () {
            setLoadedImages(_objectSpread(_objectSpread({}, loadedImages), {}, _defineProperty({}, 'item-' + selectedItem, {
              error: false
            })));
          }, 200);
        }
